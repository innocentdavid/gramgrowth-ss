        ...
        if (user) {
            ...
            <div class="rounded-[14px] shadow-[0px_4px_4px_0px_rgba(0,_0,_0,_0.25)] overflow-hidden">
              ...
              <div class="px-4 md:px-0">
                  ...
                  <div
                    ...
                    <div class="flex items-center justify-center cursor-pointer text-[600]"
                      ...
                      <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512"
                        class="w-[12px] mr-[16px] ml-[7px]" height="14px" width="16px"
                ...
                <div class="flex flex-col lg:flex-row items-center justify-between gap-[25px] md:px-10 mt-[35px]">
                  <!-- user -->
                  <div
                    class="flex flex-col md:flex-row justify-center md:justify-start items-center rounded-xl border border-[#E0E3EF] bg-[#F9F9FB] md:h-[124px] px-5 md:pl-5 md:pr-16 py-[13px] w-full md:w-fit">
                    <!-- image -->
                    ...
                    <div class="flex flex-col text-center md:text-start mt-5 md:mt-0">
                      <div
                        ...
                        ${user.full_name}<img alt="" class="lg:hidden platform-logo"
                          src="https://app.SproutySocial.com/instagram.svg" width="16px" height="16px">
                      </div>
                      <div class="mt-[6px] mb-3 text-[14px] leading-[16.8px] font-semibold text-[#5A6387]">
                        @${user.username}</div>
                  ...
                  <!-- stats -->
                  <div class="flex flex-col md:flex-row items-center justify-center gap-[15px] w-full">
                    <div
                      class="flex-1 py-6 md:py-0 min-w-[190px] md:min-w-[150px] max-w-[190px] border border-[#E0E3EF] h-[124px] rounded-xl overflow-hidden flex flex-col justify-center items-center">
                    ...
                    <div
                      class="flex-1 py-6 md:py-0 min-w-[190px] md:min-w-[150px] max-w-[190px] border bg-[#1B89FF] text-white h-[124px] rounded-xl overflow-hidden flex flex-col justify-center items-center">
